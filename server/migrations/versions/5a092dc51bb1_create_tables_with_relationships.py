...
Revision ID: 5a092dc51bb1
Revises: 
Create Date: 2026-02-13 12:01:27.650345
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['session_id'], ['sessions.id'], name=op.f('fk_session_speaker_session_id_sessions'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['speaker_id'], ['speakers.id'], name=op.f('fk_session_speaker_speaker_id_speakers'), ondelete='CASCADE'),
